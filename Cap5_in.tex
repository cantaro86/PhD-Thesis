...
\end{Definition}
Let us verify that the assumption (\ref{assumption_DPP}) is satisfied. Let us consider only the case $j=0$, because for $j=w,b$ the generalization is straightforward.
\begin{Theorem}
...
\begin{proof}
 ...
 \end{align*}
The term $\E_{t,b,y,s}\bigl[ \sup_{u\in[t,T]} S_u \bigr]$ is finite because of (\ref{cond_3}).
