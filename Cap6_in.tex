...
In this way, the number of shares to buy or sell is more sensitive to the variation of the log-price.
...
\begin{figure}[t!]
 \begin{minipage}[b]{0.5\linewidth}
   \centering
   \includegraphics[width=\linewidth]{Mert61_31.png}
 ...
 \begin{minipage}[b]{0.5\linewidth}
  \centering
   \includegraphics[width=\linewidth]{Mert101_31.png}
...
The main problems are the high dependence of the price on the parameter $\epsilon$ and therefore on the discretization step $h_x$, together with the nonlinearity of the algorithm.
...
According to the convergence analysis in section \ref{numerical_concergence_section}, we expect to have good convergence results in our algorithm when $N\sim 10^4$.
...
In this section we use the multinomial approximation method presented in chapter \ref{Chapter3}, in place of the discretization proposed in this chapter.
...
\end{minipage}
 ...
 \begin{minipage}{0.5\linewidth}
  %\centering
   \includegraphics[width=\linewidth]{Multinom_1.png}
...
However, more emphasis has been given to the reduced problem (\ref{minimization}), which is also the main topic of the paper \cite{Canta}.
